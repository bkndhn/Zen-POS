-- Fix secure_create_bill to support mixed bills (POS + Calci items) in a single bill
...
BEGIN
  ...
  LOOP
    ...
    -- MIXED CART FIX: Deduct stock only for items that actually have an ID (i.e. POS items)
