...
ALTER TABLE bill_items ADD COLUMN item_name_override text;
ALTER TABLE bill_items ADD COLUMN IF NOT EXISTS billing_type text DEFAULT 'pos';
ALTER TABLE bills ADD COLUMN billing_type text DEFAULT 'pos';
ALTER TABLE shop_settings ADD COLUMN calci_billing_enabled boolean DEFAULT false;
...
BEGIN
  ...
  INSERT INTO bills (
    ...
    is_deleted, is_edited, billing_type
  ) VALUES (
