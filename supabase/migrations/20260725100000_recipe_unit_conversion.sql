-- Add recipe_unit column to recipes table
-- When NULL, quantity is assumed to be in the ingredient's native unit (backward compatible)
ALTER TABLE public.recipes ADD COLUMN IF NOT EXISTS recipe_unit TEXT DEFAULT NULL;
  ...
  LOOP
    ...
    IF v_billing_type != 'calci' THEN
      ...
      LOOP
        ...
        -- Apply unit conversion if recipe_unit differs from ingredient's stock unit
