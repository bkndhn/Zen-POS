-- Migration: Add email column to public.profiles and update handle_new_user trigger

ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS email TEXT;

-- Populate email from auth.users for all existing records
...
BEGIN
  ...
  -- Insert or update profile with all metadata including email
