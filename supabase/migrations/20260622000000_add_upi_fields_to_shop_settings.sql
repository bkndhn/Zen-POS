-- Add UPI payment columns to shop_settings
ALTER TABLE public.shop_settings ADD COLUMN IF NOT EXISTS upi_id text;
ALTER TABLE public.shop_settings ADD COLUMN IF NOT EXISTS upi_name text;
ALTER TABLE public.shop_settings ADD COLUMN IF NOT EXISTS qr_payment_enabled boolean DEFAULT false NOT NULL;
