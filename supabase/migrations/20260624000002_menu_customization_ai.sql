-- Migration to add Menu Customization and AI features
ALTER TABLE shop_settings
ADD COLUMN IF NOT EXISTS menu_layout_style text DEFAULT 'classic',
ADD COLUMN IF NOT EXISTS menu_font_family text DEFAULT 'Inter',
ADD COLUMN IF NOT EXISTS menu_border_radius text DEFAULT 'md',
ADD COLUMN IF NOT EXISTS menu_glassmorphism boolean DEFAULT false,
ADD COLUMN IF NOT EXISTS menu_ai_features_enabled boolean DEFAULT false;

-- Update get_public_shop_settings_for_branch to return these new fields
