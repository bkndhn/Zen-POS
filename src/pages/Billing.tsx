        ...
        <div className="flex items-center justify-between gap-3">
          <div className="flex flex-col gap-2 flex-1 min-w-0">
            ...
            {!isInCart && item.quick_chips && item.quick_chips.length > 0 && (
              <div className="flex items-center gap-1.5 flex-nowrap overflow-x-auto pb-1 w-full [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                {item.quick_chips.map((chip, idx) => {
                  const isAmt = chip.startsWith('₹');
                  return (
                    <button
          ...
          {/* Add / Quantity control - vertically centered right */}
